...
public class DragAndDrop {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement galery = driver.findElement(By.id("gallery"));

		action.dragAndDrop(image1, galery).perform();
		Thread.sleep(2000);

		action.dragAndDrop(image2, galery).perform();
		Thread.sleep(2000);
		action.dragAndDrop(image3, galery).perform();

		Thread.sleep(2000);
		action.dragAndDrop(image4, galery).perform();
